...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2025 at 01:14 AM
...
INSERT INTO `ctphieunhap` (`MACTPN`, `MAPN`, `MANGUYENLIEU`, `MADONVI`, `SOLUONG`, `SOLUONGCOSO`, `DONGIA`, `THANHTIEN`) VALUES
(1, 1, 2, 2, 2.00, 2.00, 1.00, 2.00),
(2, 1, 3, 9, 1.00, 1.00, 1.00, 1.00),
(3, 2, 4, 9, 6.00, 6.00, 1.00, 6.00),
(4, 2, 5, 8, 4.00, 96.00, 24.00, 96.00);
...
(1, 'abc', '0944299123', 'm@gmail.com', 0, '2025-11-14 13:17:26'),
(2, 'khanh', '0848001235', 'eqưeqư@gmail.com', 1, '2025-11-25 22:09:31');
...
(1, 'Bột cà phê', 1, 60.000, 1, 2),
(2, 'Đường trắng', 1, 82.000, 1, 2),
(3, 'Sữa đặc', 1, 101.000, 1, 2),
(4, 'Sữa tươi không đường', 1, 31.000, 1, 4),
(5, 'Coca cola', 1, 2096.000, 1, 5);
...
(1, 'Cafe Trung Nguyên', '0901234567', 'sales@trungnguyen.vn', 'long an', 1),
(2, 'suu', '1234890191', '123132123@gmail.com', 'ninh bình', 0),
(5, 'qưeqưeqư', '123124134', 'ygygy@gmail.com', 'tây ninh', 1);
...
INSERT INTO `phieunhap` (`MAPN`, `MANCC`, `THOIGIAN`, `TRANGTHAI`, `MANHANVIEN`, `TONGTIEN`) VALUES
(1, 1, '2025-11-26 05:24:14', 1, 1, 3.00),
(2, 5, '2025-11-26 05:50:41', 1, 1, 102.00);
